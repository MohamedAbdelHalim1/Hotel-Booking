...
--
-- Host: localhost:3306
-- Generation Time: Jun 12, 2024 at 09:20 PM
...
(6, '2024_06_11_081920_create_hotels_table', 1),
(7, '2024_06_11_081921_create_rooms_table', 1),
(8, '2024_06_11_081929_create_bookings_table', 1);
...
CREATE TABLE `rooms` (
  ...
  `status` enum('available','booked','pending') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'available',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
